...
st.markdown('<p class="desc" style="color: green;" >Upload an image or take a picture, and the AI will classify it as <b>Recyclable</b>, <b>Biodegradable</b>, or <b>Non-Recyclable</b>.</p>', unsafe_allow_html=True)
